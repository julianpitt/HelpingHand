 ...
 */
@Entity
@Table(name="localitytrend")
public class LocalityTrendEntity {
    private int id;
    ...
    public LocalityTrendEntity() {}

    public LocalityTrendEntity(int id, TrendTypeEntity trendType, double value, Date startDate, Date endDate, LocalityEntity locality) {
        this.id = id;
