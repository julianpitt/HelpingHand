 ...
 */
@Entity
@Table(name="streetusage")
public class StreetUsageEntity {
    private int id;
    ...
    public StreetUsageEntity() {
    }

    public StreetUsageEntity(int id, TrendTypeEntity trendType, double value, Date startDate, Date endDate, StreetEntity street) {
        this.id = id;
